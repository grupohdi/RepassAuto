...
export class MyVehiclesPage implements OnInit {
  ...
  public company: any;
  public vehicles: any[];
  public carregando: string = "Procurando Veículos cadastrados...";
  ...
  carregarVeiculosRefresh(refresher: any) {
  ...
  async adicionarVeiculo() {
    ...
    let navigationExtras: NavigationExtras = { state: { vehicleId: "" } };
  ...
  async apagarVeiculo(vehicle: any) {
  ...
  async doRefresh(refresher) {
    this.carregarVeiculosRefresh(refresher);
  }

  async ordenarVeiculos() {
